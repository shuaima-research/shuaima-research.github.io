---
title: "Engineering Controlled Flexibility"
lang: en
toc: true
toc-depth: 2
format:
...
![Cover: a verticalized M0 research-and-office tower in Shenzhen, the built signature of the "industry-goes-vertical" agenda.](figures/fig0_cover.png){width=82%}
...
![Figure 1. China crosses the world urbanization average around 2013–14, the moment the "New Normal" reframed growth as intensive and quality-oriented.](figures/fig1_urbanization.png){width=88%}
...
![Figure 2. Institutional evolution of Shenzhen's M0 category, 2008–2020: each policy generation tightens the terms of flexibility.](figures/fig2_timeline.png){width=88%}
...
![Figure 3. The M0 regulatory logic: developmental flexibility on one side, anti-financialization controls on the other, fused into a single conditional land right.](figures/fig4_framework.png){width=88%}
...
![Figure 4. Shenzhen sets the lowest FAR floor yet the highest saleable-area cap of the PRD cities—distributing regulatory burden onto its block-line and district performance regimes instead.](figures/fig3_far_transfer.png){width=88%}
...
![Figure 5. The delivered M0 product: high-density, campus-like complexes pairing R&D and office towers with a ground-level amenity podium—readily subdivided and sold.](figures/fig5_product_form.jpg){width=88%}
...
![Figure 6. The Industrial Block-Line as spatial counterweight: nested caps progressively ring-fence productive land, offsetting M0's building-scale saleability.](figures/fig6_blockline.png){width=88%}
