...
![Figure 1. Analytical framework: a dual-track feasibility model coupled to a regulatory land-pricing module.](figures/fig1_framework.png)
...
![Figure 2. Static profitability structure of the generic worked example.](figures/fig2_waterfall.png)

![Figure 3. Dynamic (DCF) cash-flow profile of the generic worked example.](figures/fig3_dcf.png)
...
![Figure 4. Land premium decomposition by redevelopment pathway (case study).](figures/fig4_premium.png)
...
![Figure 5. From land premium to floor land price (case study).](figures/fig5_landcost.png)
