---
title: "Living Safely with Water: Sponge-City Design for the Urban Waterfront"
subtitle: "A cross-case framework matching LID configurations to waterfront site types"
date: "2017"
lang: en
toc: true
toc-depth: 2
...
<p style="font-size:0.9rem; color:var(--muted); margin-top:-0.5rem; margin-bottom:2rem;">
  Shuai Ma &nbsp;·&nbsp; Internal Research Report &nbsp;·&nbsp; Atkins &nbsp;·&nbsp; 2017
</p>
...
### Gengwan: Mountain-to-Lake New District
...
![Original Gengwan ecological drainage network diagram](assets/gengwan-ecological-drainage-network-original.png){width=50%}

*Figure 1. Drainage network, flow directions, lake system, and outlets, extracted from the original project deck.*

![Original SWMM model of Gengwan](assets/swmm-gengwan-model.jpg){width=80%}
...
Node-level results still showed one low-lying subcatchment as the dominant ponding hotspot, so the fix was spatial: more swale length and depressed detention at the flagged nodes. In the refined 50-yr scenario ~6,551 m³ entered the lake for a +0.12 m rise with no site flooding.

![Original dry-creek reference photograph](assets/gengwan-dry-creek-reference-original.jpg){width=80%}

*Figure 3. Stepped rock channel: it dissipates energy and turns conveyance into a landscape feature.*

### Mawan: Industrial Waterfront
...
![Original Mawan sponge-city plan](assets/mawan-sponge-city-plan-original.jpg){width=80%}

*Figure 4. Mawan site plan: blue corridors route runoff through green space and wetland around the buildings.*

![Original Mawan rainwater-wetland rendering](assets/mawan-rainwater-wetland-render-original.jpg){width=80%}

*Figure 5. The wetland detains and filters runoff while doubling as habitat and a public route.*

### Kunshan: Flat, High-Groundwater Residential
...
![Original bioretention-section illustration](assets/kunshan-bioretention-section-original.jpg){width=80%}

*Figure 6. Bioretention section: the planted depression stores, filters, and infiltrates beside the developed surface.*

### Houhai and Suhewan: Dense Infill and CBD Plot
