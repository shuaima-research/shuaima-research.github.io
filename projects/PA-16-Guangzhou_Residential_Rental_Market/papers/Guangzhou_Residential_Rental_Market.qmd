...
```{=html}
<div class="cp-header">
  <div class="cp-tag">Research Brief · Internal Research Report · Ping An Group · September 2021</div>
  <h1 class="cp-title">Empirical Analysis of Guangzhou Residential Rental Markets</h1>
  <div class="cp-meta">
    <span class="cp-author">Shuai Ma</span> &nbsp;·&nbsp; <a href="https://github.com/shuaima-research/PA-16-Guangzhou_Residential_Rental_Market-Github" target="_blank">Code (GitHub)</a>
  </div>
</div>
```
